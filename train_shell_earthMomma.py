...
training_data_dir = "/home/abdohero/train_new_font/train_earthMomma/earthMomma-ground-truth"
...
#                 "--save_box_tiff",
#                 "--maxpages", "10",
#                 "--output_dir", "train_earthMomma/earthMomma-ground-truth"])
...
subprocess.run(["lstmtraining",
                ...
                "--train_listfile", "train_earthMomma/earthMomma-ground-truth/eng.training_files.txt",
                "--max_iterations", "5000"])
